...
arc3p :: Parser SchematicItem
coil :: Parser SchematicItem
component :: Parser SchematicItem
ellipse :: Parser SchematicItem
junction :: Parser SchematicItem
line :: Parser SchematicItem
net :: Parser SchematicItem
pin :: Parser SchematicItem
rect :: Parser SchematicItem
spiceText :: Parser SchematicItem
triangle :: Parser SchematicItem
wire :: Parser SchematicItem
zigzag :: Parser SchematicItem

tryThese :: [Parser a] -> Parser a
tryThese = List.foldl' (<|>) empty
